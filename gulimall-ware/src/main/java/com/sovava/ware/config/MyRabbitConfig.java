package com.sovava.ware.config;
...
//    }
    ...
    public Exchange stockEventExchange() {
        TopicExchange stockEventExchange = new TopicExchange("stock-event-exchange", true, false);
        return stockEventExchange;
    }
    ...
    public Queue stockDelayQueue() {
        ...
        arguments.put("x-message-ttl", 12 * 1000);
